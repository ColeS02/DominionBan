...
import com.unclecole.dominionban.database.seralizer.DiscUtil;
...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(DominionBan.instance.getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            DominionBan.instance.getLogger().info("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            DominionBan.instance.getLogger().warning("Using default as I failed to load: " + file);
            ...
            DominionBan.instance.getLogger().warning("Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            DominionBan.instance.getLogger().warning(ex.getMessage());
        }
